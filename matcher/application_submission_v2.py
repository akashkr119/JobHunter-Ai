"""Safe submission execution primitives built on explicit authorization.

This module deliberately provides an adapter boundary rather than browser
automation. Adapters must implement a supported/authorized application flow.
"""
