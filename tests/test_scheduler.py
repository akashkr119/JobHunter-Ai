...
def sample_job(url="https://example.com/jobs/1",description="Python Selenium Pytest Docker",platform="greenhouse"):return Job(title="QA Automation Engineer",company="Example",location="Bengaluru",apply_url=url,description=description,platform=platform)
